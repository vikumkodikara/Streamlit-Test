...
st.caption("Warning and error examples are optional demos below.")
c1, c2 = st.columns(2)
if c1.button("Show warning demo"):
    st.warning("Demo warning: Missing values detected in 3 columns.")
if c2.button("Show error demo"):
    st.error("Demo error: Model file not found at models/clf.pkl")
